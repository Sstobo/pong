...
var Game = function () {
		function Game(element, width, height) {
				...
				// Score board		
				this.score1 = new _Score2.default(10, 30, 30);
				this.score2 = new _Score2.default(270, 30, 30);
				// ball instantiator ( plus bonus balls)
				this.radius = 10;
				this.ball = new _Ball2.default(this.radius, this.width, this.height);
				this.ball2 = new _Ball2.default(this.radius + 5, this.width, this.height);
				this.ball3 = new _Ball2.default(this.radius - 5, this.width, this.height);
				...
				this.paddle1 = new _Paddle2.default(this.height, this.paddleWidth, this.paddleHeight, this.boardGap, this.paddleStart, _settings.KEYS.a, _settings.KEYS.z);

				// right paddle
				this.paddle2 = new _Paddle2.default(this.height, this.paddleWidth, this.paddleHeight, this.width - this.boardGap - this.paddleWidth, this.paddleStart, _settings.KEYS.up, _settings.KEYS.down);
  ...
  _createClass(Ball, [{
    ...
    value: function paddleCollision(paddle1, paddle2) {
      if (this.vx > 0) {
        ...
        var player = paddle2.coordinates(paddle2.x, paddle2.y, paddle2.width, paddle2.height);
        // destructuring array 

        var _player = _slicedToArray(player, 4),
            leftX = _player[0],
            rightX = _player[1],
            topY = _player[2],
            bottomY = _player[3];
        ...
        var _player2 = paddle1.coordinates(paddle1.x, paddle1.y, paddle1.width, paddle1.height);

        var _player3 = _slicedToArray(_player2, 4),
            _leftX = _player3[0],
            _rightX = _player3[1],
            _topY = _player3[2],
            _bottomY = _player3[3];
